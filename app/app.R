...
ui <- fluidPage(includeCSS("style.css"),
                ...
                navbarPage(p(class="h","Foodie Safeguard", align = "center"),
                           ...
                           tabPanel(h1("Data Map Visualization"),
                                    div(class="outer",
                                        ...
                                        sidebarLayout(
                                          ...
                                          mainPanel(
                                            leafletOutput("nyc_map", height = "95vh")
                                          )
                                        )
                                    )),
                           tabPanel(h1("Crime Trend"),
                                    div(class="outer",
                                        tags$style(type = "text/css", ".outer {position: relative; fixed: 41px; left: 0; right: 0; bottom: 0; overflow: hidden; padding: 0}"),
                                        #sidebarLayout(
                                        fluidRow(
                                          column(width = 12,
                                                 tags$hr(),
                                                 ...
                                                 fluidRow(
                                                   column(
                                                     12, align = "center",
                                                     plotlyOutput("crime_trend",height = "70vh")
                                                   )
                                                   # mainPanel(
                                                   #   div(plotlyOutput("crime_trend",height = "100%"), align = "center"
                                                   #   )
                                                   #)
                                                 ))))
                           ),
                           tabPanel(h1("The Proportion of Offense Level"),
                                    div(class="outer",
                                        tags$style(type = "text/css", ".outer {position: fixed; top: 41px; left: 0; right: 0; bottom: 0; overflow: hidden; padding: 0}"),
                                        fluidRow(
                                          column(width = 12,
                                                 ...
                                                 tags$hr(),
                                                 fluidRow(
                                                   column(12, align="center",plotlyOutput("offense_hour", height = "60vh"))
                                                   
                                                 ))))),
                           tabPanel(h1("Offense Proportion by Borough"),
                                    div(class="outer",
                                        tags$style(type = "text/css", ".outer {position: fixed; top: 41px; left: 0; right: 0; bottom: 0; overflow: hidden; padding: 0}"),
                                        fluidRow(
                                          column(width = 12,
                                                 ...
                                                 tags$hr(),
                                                 fluidRow(
                                                   column(12, align="center",plotlyOutput("crime_type", height = "60vh"))
                                                   
                                                 ))    
                                        ))),
                           tabPanel(h1("Offense Date and Time"),
                                    div(class="outer",
                                        tags$style(type = "text/css", ".outer {position: fixed; top: 41px; left: 0; right: 0; bottom: 0; overflow: hidden; padding: 0}"),
                                        fluidRow(
                                          column(width = 12,
                                                 ...
                                                 tags$hr(),
                                                 fluidRow(
                                                   column(12, align="center",plotlyOutput("heatmap", height = "60vh")
                                                   )))),h2("From the  Crime heatmap of Hour vs Week, we can observe that  "),
                                        
                                        h6("(1)Compared to Sunday, Crimes break out from Monday to Friday,especially Tuesday, Thursday and Friday, Sunday and are ratively safe."),
                                        
                                        h6("    (2)Most Dangerous Priod are 12pm and 14pm-20pm on Weekdays, that is probablely when people have a noon break, get off work or on the way home. Compared to Monday and Wednesday, crimes break out more on Tuesday, Thursday and Friday."), 
                                        
                                        h6("  (3)Ralatively Dangerous Priod are 8am-11am and 21pm-12am on Weekdays."),
                                        
                                        h6("  (4)Crimes occourred not so that frequently during 1am-7am, however, crimes occourred more frequently during 1am- 4am on Saturday and Sunday.")
                                    )),
                           tabPanel(h1("Contact"),fluidPage(
                             sidebarLayout(
                               sidebarPanel(
                                 ...
                                 hr(),
                                 h6("Mengqi Chen, mc4398@columbia.edu  "),
                                 h6("Shiqing Long, sl4225@columbia.edu   "),
                                 h6("Anke Xu, ax2127@columbia.edu   "),
                                 h6("Sen Fu, sf2873@columbia.edu  "),
                                 hr(),
                                 h6("Data Source: "),
                                 h6("NYC Open Data, NYPD Open Data")),
                               mainPanel(
                               )
                               )
                           )
